...
public class EstatisticasCinema2 {
    public static void main(String[] args) {
        ...
        int a = 0, b = 0, c = 0, d = 0, e = 0, idadeD = 0, idadeE = 0, cont = 0;
        String nota;

        System.out.println("Digite nota F para finalizar.");
        do {
            ...
            nota = leitura.nextLine();

            if (!nota.equalsIgnoreCase("f")) {
        ...
        } while (!nota.equalsIgnoreCase("f"));

        var mediaD = idadeD / d;
        var porcentagem = ((e / cont) * 100);
